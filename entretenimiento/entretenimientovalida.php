...
<div id="resultado-container" class="container text-center mt-5 p-4">
    <h1>Resultado del Juego</h1>

    <?php
    // Recibe el valor oculto y las localidades ingresadas desde el formulario anterior
    $oculto2 = $_POST['oculto2'];
    $input1 = $_POST['localidad1'] . " ";
    $input2 = $_POST['localidad2'] . " ";
    $input3 = $_POST['localidad3'] . " ";
    $input4 = $_POST['localidad4'] . " ";
    $input5 = $_POST['localidad5'] . "";

    // Elimina cualquier coma en el valor oculto para hacer una comparación limpia
    $oculto2 = str_replace(",", "", $oculto2);

    // Concatena las localidades ingresadas en una sola cadena
    $cadenalocalidades = $input1 . $input2 . $input3 . $input4 . $input5;

    // Verifica si la cadena de localidades ingresadas coincide con el valor oculto
    if ($oculto2 == $cadenalocalidades) {
        // Mensaje de éxito
        echo "<div class='result correct'>¡Correcto! Ganaste una chocolatina Tirma.</div>";
        echo "<div class='img-container'><img src='img/tirma.jpg' alt='Chocolatina Tirma'></div>";
        echo "<meta http-equiv='refresh' content='20;url=entretenimientoprinci.php' />";
    } else {
        // Mensaje de error
        echo "<div class='result incorrect'>Sigue intentándolo.</div>";
        echo "<meta http-equiv='refresh' content='20;url=entretenimientoprinci.php' />";
    }
    ?>
</div>
