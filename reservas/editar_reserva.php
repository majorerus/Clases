...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sqlUpdate = "UPDATE reservas SET idHotel = '$idHotel', nombreCliente = '$nombreCliente', emailCliente = '$emailCliente', 
                  fechaReserva = '$fechaReserva', fechaIngreso = '$fechaIngreso', fechaSalida = '$fechaSalida', 
                  numeroPersonas = '$numeroPersonas' WHERE idReserva = $idReserva";

    if ($conn->query($sqlUpdate) === TRUE) {
        echo "Reserva actualizada correctamente.";
        header("Location: ver_reservas.php"); // Redirige a la lista de reservas
    } else {
       ...
       <div class="container mt-4">
        ...
        <form action="" method="POST">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="idHotel" name="idHotel" value="<?= htmlspecialchars($reserva['idHotel']); ?>" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nombreCliente" name="nombreCliente" value="<?= htmlspecialchars($reserva['nombreCliente']); ?>" required>
            </div>
            <div class="mb-3">
                <label for="emailCliente" class="form-label">Correo Electrónico</label>
                <input type="email" class="form-control" id="emailCliente" name="emailCliente" value="<?= htmlspecialchars($reserva['emailCliente']); ?>" required>
            </div>
            <div class="mb-3">
                <label for="fechaReserva" class="form-label">Fecha de Reserva</label>
                <input type="date" class="form-control" id="fechaReserva" name="fechaReserva" value="<?= htmlspecialchars($reserva['fechaReserva']); ?>" required>
            </div>
            <div class="mb-3">
                <label for="fechaIngreso" class="form-label">Fecha de Ingreso</label>
                <input type="date" class="form-control" id="fechaIngreso" name="fechaIngreso" value="<?= htmlspecialchars($reserva['fechaIngreso']); ?>" required>
            </div>
            <div class="mb-3">
                <label for="fechaSalida" class="form-label">Fecha de Salida</label>
                <input type="date" class="form-control" id="fechaSalida" name="fechaSalida" value="<?= htmlspecialchars($reserva['fechaSalida']); ?>" required>
            </div>
            <div class="mb-3">
                <label for="numeroPersonas" class="form-label">Número de Personas</label>
                <input type="number" class="form-control" id="numeroPersonas" name="numeroPersonas" value="<?= htmlspecialchars($reserva['numeroPersonas']); ?>" required>
            </div>
